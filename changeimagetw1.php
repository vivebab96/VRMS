...
$vehimg=md5($img).$extension;
    ...
    $query=mysqli_query($con, "update tblvehicle set Image1 ='$vehimg' where ID='$imgid'");
    if ($query) {
...
<head>
    <title>Vehicle Rental Management Sysytem | Vehicle Two Wheeler Image1</title>
...
<body>
    ...
    echo $msg;
                        ...
                        <?php
 $imgid=$_GET['editid'];
$ret=mysqli_query($con,"select * from  tblvehicle where ID='$imgid'");
$cnt=1;
