...
$vehimg=md5($img).$extension;
    ...
    $query=mysqli_query($con, "update tblvehiclecar set Image5 ='$vehimg' where ID='$imgid'");
    if ($query) {
...
<head>
    <title>Vehicle Rental Management Sysytem | Vehicle Four Wheeler Image5</title>
...
<body>
    <div class="wrapper">
       ...
       <?php include_once('includes/header.php');?>
            ...
            <!-- main-heading -->
            <h2 class="main-title-w3layouts mb-2 text-center"> Vehicle Image</h2>
            <!--// main-heading -->
            ...
            <section class="forms-section">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4"> Vehicle Image</h4>
    ...
    echo $msg;
                        ...
                        <?php
 $imgid=$_GET['editid'];
$ret=mysqli_query($con,"select * from  tblvehiclecar where ID='$imgid'");
$cnt=1;
...
?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">New Vehicle Image</label>
