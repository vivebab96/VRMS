...
<head>
    <title>Vehicle Rental Management Sysytem | Unapproved Four Wheeler Booking</title>
...
<body>
   ...
   <?php include_once('includes/sidebar.php');?>
       ...
       <?php include_once('includes/header.php');?>
            ...
            <!-- main-heading -->
            <h2 class="main-title-w3layouts mb-2 text-center">Unapproved Four Wheeler Booking</h2>
            <!--// main-heading -->
            ...
            <section class="tables-section">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Unapproved Four Wheeler Booking</h4>
